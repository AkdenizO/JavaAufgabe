...
public class UeberpruefungPfandMitMethod {
	...
	public static void main(String[] args) {
        ...
        1… einen String von der Konsole einliest, z.B. c:\dateien\xyz.txt
        2… prüft, ob ein gültiger Pfad einer txt-Datei eingegeben wurde
            - erstes Zeichen C oder D (optional: beliebiger Buchstabe, case-insensitive)
            - zweites Zeichen : (Doppelpunkt)
            - drittes Zeichen \ oder /
            - die letzten 4 Zeichen sind .txt
            - Zwischen dem letzten \ oder / und .txt muss mindestens ein Buchstabe (a-z) vorhanden sein
        3… das Ergebnis der Prüfung ausgibt (Pfad gültig oder ungültig)*/
